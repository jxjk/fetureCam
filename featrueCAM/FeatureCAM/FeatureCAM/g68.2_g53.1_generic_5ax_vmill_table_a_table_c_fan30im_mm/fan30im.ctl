<?xml version="1.0"?>
<VcControl Version="9.0" Unit="millimeter">
  <Information>
    <InfoUserName>Administrator</InfoUserName>
    <InfoDateTime>Wed Apr  1 22:46:45 2020</InfoDateTime>
    <InfoVericutVersion>9.0.1</InfoVericutVersion>
    <InfoBuildDate>March 02, 2020 </InfoBuildDate>
    <InfoLibraryDate>03/02/20</InfoLibraryDate>
    <InfoCustomerName>LND-7330757468@CS</InfoCustomerName>
    <InfoCustomerID>094671</InfoCustomerID>
    <InfoServerID>001</InfoServerID>
    <InfoHostID>e4a7260eac6f</InfoHostID>
  </Information>
  <COMMENT>Library File: fan30im.ctl, Revision 1.12, Issued: 1/29/2020 8:46:40 AM</COMMENT>
  ...
  <SuperGroup Name="States">
    ...
    <Group Name="G" Type="word" Description="Tool axis direction control" Range="53.1" Field="0">
      <ConditionMacro>
        <CondVariable Logical="and" Name="MP_19680" Range="12"/>
        <Macro Name="MessageMacro" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="4"  Units="0"/>
          <Override  Type="text"  Value="MP_19680 = 12, 2 table rotaries"/>
        </Macro>
  ...
  <SuperGroup Name="Variables">
    ...
    <Group Name="3006" Type="variable" Description="" Field="0">
      <ConditionMacro>
        <Macro Name="LoggerMessage" Scan="no" AfterMotion="yes">
          <Override  Type="text"  Value="#3006 {#CGT_Comment}"/>
        </Macro>
        <Macro Name="StopUnconditional" Scan="no" AfterMotion="yes">
        </Macro>
      </ConditionMacro>
    </Group>
  ...
  <SuperGroup Name="Registers">
    <Group Name="A" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <CondVariable Logical="and" Name="CGT_IJKMOTION" Range="&lt;&gt;0"/>
    ...
    <Group Name="I" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <CondWord Logical="and" Name="Q" Range="123"/>
        <Macro Name="RotationPlaneAngle1" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="X TWO"/>
        </Macro>
        <Macro Name="RotationPlaneAngle1" Scan="no" AfterMotion="yes">
          <Override  Type="value"  Value="0"  Units="0"/>
          <Override  Type="text"  Value="TWO"/>
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="68.4"/>
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="68.4"/>
        <Macro Name="RotationPlaneAngle3" Scan="no" AfterMotion="yes">
          <Override  Type="text"  Value="Z TWO"/>
        </Macro>
        <Macro Name="RotationPlaneAngle3" Scan="no" AfterMotion="yes">
          <Override  Type="value"  Value="0"  Units="0"/>
          <Override  Type="text"  Value="TWO"/>
    ...
    <Group Name="J" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <CondWord Logical="and_not" Name="Q"/>
        <Macro Name="RotationPlaneAngle2" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="Y TWO"/>
        </Macro>
        <Macro Name="RotationPlaneAngle2" Scan="no" AfterMotion="yes">
          <Override  Type="value"  Value="0"  Units="0"/>
          <Override  Type="text"  Value="TWO"/>
    ...
    <Group Name="P" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <Macro Name="Ijk2AnglesInput" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="ABC"/>
        </Macro>
        <Macro Name="Ijk2AnglesPickSolution" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="11 12"/>
        </Macro>
        <Variable Name="CGT_IJKMOTION" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="ABS(#(26003+($*10))) + ABS(#(26004+($*10))) + ABS( #(26005+($*10)))"  Units="0"/>
        </Variable>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="65 66 66.1"/>
  ...
  <SuperGroup Name="G_Prep">
    ...
    <Group Name="G" Type="word" Description="Coordinate system rotation / 3D Coordinate system rotation" Range="68" Field="0">
      ...
      <ConditionMacro>
        <CondVariable Logical="and" Name="MP_11600[5]" Range="1"/>
        <CondState Logical="and" Name="MOTION_PLANE" Value="XY"/>
        <CondWord Logical="and_not" Name="R"/>
        <Variable Name="4016" Scan="no" AfterMotion="no">
        </Variable>
        ...
        <Macro Name="RotationPlaneAngle1" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#MP_05410"  Units="0"/>
          <Override  Type="text"  Value="Z"/>
        </Macro>
      ...
      <ConditionMacro>
        <CondVariable Logical="and" Name="MP_11600[5]" Range="0"/>
        <CondState Logical="and" Name="MOTION_PLANE" Value="XY"/>
        <CondWord Logical="and_not" Name="R"/>
        <Variable Name="4016" Scan="no" AfterMotion="no">
        </Variable>
        ...
        <Macro Name="RotationPlaneLocal" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondVariable Logical="and" Name="MP_11600[5]" Range="0"/>
    ...
    <Group Name="G" Type="word" Description="Incremental tilted working plane command" Range="68.4" Field="0">
      <ConditionMacro>
        <CondVariable Logical="and" Name="4007" Range="41 42"/>
        <Macro Name="MessageMacro" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="1"  Units="0"/>
          <Override  Type="text"  Value="*** PS5462 ILLEGAL COMMAND *** Cancel Tool Radius Comp"/>
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondVariable Logical="and" Name="4033" Range="54.4"/>
        <Macro Name="MessageMacro" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="1"  Units="0"/>
          <Override  Type="text"  Value="*** PS0437 ILLEGAL COMMAND IN WSC *** Cancel G54.4 WSEC"/>
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <Variable Name="4016" Scan="no" AfterMotion="no">
    ...
    <Group Name="G" Type="word" Description="Coordinate system rotation cancel" Range="69" Field="0">
      ...
      <ConditionMacro>
        <CondVariable Logical="and" Name="4016" Range="68"/>
        <Variable Name="4016" Scan="no" AfterMotion="no">
        </Variable>
        <Variable Name="4216" Scan="no" AfterMotion="no">
        </Variable>
  ...
  <Events>
    <Event Type="conversion_init">
      ...
      <EventSub Name="1">
        ...
        <Macro Name="WPInput" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="4"  Units="0"/>
          <Override  Type="text"  Value="24"/>
        </Macro>
        <Macro Name="OptiPathOptimizeCDC" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="1"  Units="0"/>
        </Macro>
        <Macro Name="GetCommentString" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="CGT_Comment"/>
        </Macro>
      </EventSub>
    </Event>
  ...
  <MacroModals>
    ...
    <MacroModal Name="mmTOLERANCE_VALUE"  Value="0.0254"/>
    ...
    <MacroModal Name="mmDEFAULT_FEEDRATE"  Value="25.4"/>
    ...
    <MacroModal Name="mmMAX_CUT_FEED_RATE"  Value="2540"/>
    ...
    <MacroModal Name="mmCYCLE_CLEARANCE_DISTANCE"  Value="2.54"/>
